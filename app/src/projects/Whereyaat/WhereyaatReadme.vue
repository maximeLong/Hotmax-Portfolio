    ...
    <div class="readme-group">
      ...
      <div class="readme-text">
        <ul>
          ...
          <li>Vue.js -> Node(Express) -> Mongo pipeline</li>
          <li>Rx.js streaming of geographic data</li>
          <li>Forward and reverse geocoding using open source tools</li>
        </ul>
      </div>
    </div>
    <div class="readme-group">
